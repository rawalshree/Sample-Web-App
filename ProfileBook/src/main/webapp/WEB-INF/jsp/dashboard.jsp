    ...
    <body>
        <div class="container">
            <ul id="gn-menu" class="gn-menu-main">
                ...
                <li><a onclick="window.location.href = '/ProfileBook/web/dashboard/logout';">Logout</a></li>
            </ul>as
            <header>
                    <h1> ProfileBook DashBoard</span></h1>
                    <h2> ProfileBook is a system which lets you use pre-built functionality.</span><h2>
                    <h2> Use the Side Menu options to browse and use the features.</span></h2>
            </header> 
