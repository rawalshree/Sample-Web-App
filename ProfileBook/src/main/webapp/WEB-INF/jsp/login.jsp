            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="/ProfileBook/web/register" class="signup-image-link">Create an account</a>
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Sign in</h2>
                        <h3><font color="red">${message}</h3>
                        <font color="black">
                        <form method="POST" class="register-form" action="login" id="login-form">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" style="margin:5px" name="signin" id="signin" class="form-submit" value="Log in"/>
