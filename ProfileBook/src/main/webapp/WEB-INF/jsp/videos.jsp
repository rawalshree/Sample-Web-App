...
<html lang="en" class="no-js">
    ...
    <body>
        <div class="container">
                    ...
                    <nav class="gn-menu-wrapper">
                        <div class="gn-scroller">
                            <ul class="gn-menu">
                                ...
                                <li>
                                <ul class="gn-submenu">
                                    <li><a class="gn-icon gn-icon-videos" onclick="window.location.href = '#';">Videos</a></li>
                                </ul>
            ...
            <header>
                    <h1>Videos</span></h1>
                    <h2> Here you can upload and save your videos </span></h2>
                    <h2><font color="red">This feature is still in Development and we hope to finish it soon. </span></h2>
                    <h2>Thank you for your Patience and Sorry for any inconvenience</h2>
            </header> 
        </div><!-- /container -->
